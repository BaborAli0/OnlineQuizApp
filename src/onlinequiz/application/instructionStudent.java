...
public String rollNo;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, 535, 50));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 102, 1366, 10));

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText(" \n  1.The Student may not use his or her textbook, Course notes, or any use of Artificial app or receive help \n    from a course teacher or any other outside source.\n\n  2. Student must not stop the session and then return to it. This is especially important in the online environment \n     where the system will \" time-out \" and not allow the student or  you to re-enter the exam. \n\n\t\t\t\t\t         \n                                        Number of Question: 10\n\t\t\t                Exam Duration: 10 min\n\n\t\t\t\t\t   \n\n                                                          All the Best !!!");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 1287, 427));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(837, 610, 318, 80));
    ...
    private static class quizExamStudent {
